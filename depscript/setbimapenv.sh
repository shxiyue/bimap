...
export LS_HOME={{homedir}}/{{bimapuser}}/bimap/opt/logstash-{{elkVersion}}
...
export PATH=$JAVA_HOME/bin:$ES_HOME/bin:$KIBANA_HOME/bin:$BIMAP_HOME/bin:$LS_HOME/bin:$NODE_HOME/bin:$REDIS_HOME:$PATH
